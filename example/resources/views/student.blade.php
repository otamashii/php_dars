<x-layout>
    ...
    <div class="max-w-3xl mx-auto mt-10 bg-gradient-to-br from-blue-50 via-white to-indigo-50 rounded-3xl shadow-xl border border-gray-200 p-10 relative overflow-hidden">
        ...
        {{-- Header --}}
        <div class="flex flex-col sm:flex-row items-center sm:items-start sm:justify-between gap-6 relative z-10">
            <div class="flex items-center gap-5">
                ...
                <div>
                    ...
                    <p class="text-gray-500 mt-1 text-sm">
                        Student ID: <span class="font-semibold text-gray-700">{{ $student['id'] }}</span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-10 flex justify-center relative z-10">
            <a href="/students" class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-full shadow-md hover:shadow-lg hover:scale-105 transition duration-300">
